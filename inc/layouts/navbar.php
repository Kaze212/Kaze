...
<body style="background-color:#B4E4FF">
<nav style="background-color:#30E3DF" class="navbar navbar-expand-lg shadow-sm sticky-top">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo $siteURL; ?>/admin/order.php?status=pendding" aria-current="page">Order Pending</a>
          </li>
          <li class="nav-item">
