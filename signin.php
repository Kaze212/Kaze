...
<main class="container mt-5 mb-5">
    <div class="row justify-content-center">
        <form style="background-color:#FCFFE7" class="col-sm-4 rounded-3 shadow-sm pt-3 pb-3" method="POST" action="<?php echo $siteURL; ?>/signin.php">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <a href="<?php echo $siteURL;?>" class="btn btn-primary w-100 pt-2 pb-2">Kembali</a>
                </div>
                <div class="col-sm-7">
                    <button type="submit" name="signin" class="btn btn-primary w-100 pt-2 pb-2">Login</button>
                </div>
            </div>
        </form>
    </div>
