...
<main class="container">
    ...
    <div class="row mt-3">
        ...
        ?>
            <div class="col-sm-3">
                <div style="background-color:#30E3DF" class="card w-100 border-0 rounded-3 shadow-sm mb-3">
                    <img src="<?php echo $siteURL. '/src/img/'. $data['image']; ?>" class="card-img-top" alt="<?php echo $data['name']; ?>" style="height: 200px;">
                    <div style="background-color:#30E3DF" class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <a href="<?php echo $siteURL .'/user/whistlist.php?product_id='. $data['id']; ?>" class="btn btn-outline-primary text-dark w-100">keranjang</a>
                            </div>
                            <div class="col-sm-6">
                                <a href="<?php echo $siteURL .'/user/detail.php?product_id='. $data['id']; ?>" class="btn btn-outline-primary text-dark w-100">Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
